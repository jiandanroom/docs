...
[![Maven Central](https://img.shields.io/maven-central/v/com.name_jiandan.api/name-jiandan-java)](https://central.sonatype.com/artifact/com.name_jiandan.api/name-jiandan-java/0.0.1-alpha.1)
[![javadoc](https://javadoc.io/badge2/com.name_jiandan.api/name-jiandan-java/0.0.1-alpha.1/javadoc.svg)](https://javadoc.io/doc/com.name_jiandan.api/name-jiandan-java/0.0.1-alpha.1)
...
The REST API documentation can be found on [api.example.com](https://api.example.com/support). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.name_jiandan.api/name-jiandan-java/0.0.1-alpha.1).
...
```kotlin
implementation("com.name_jiandan.api:name-jiandan-java:0.0.1-alpha.1")
```
...
To forcibly omit a required parameter or property, pass [`JsonMissing`](name-jiandan-java-core/src/main/kotlin/com/name_jiandan/api/core/Values.kt):
