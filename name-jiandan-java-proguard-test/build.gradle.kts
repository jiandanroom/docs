...
dependencies {
    testImplementation(project(":name-jiandan-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../name-jiandan-java-core/src/main/resources/META-INF/proguard/name-jiandan-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.name_jiandan.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../name-jiandan-java-core/src/main/resources/META-INF/proguard/name-jiandan-java-core.pro",
