...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.name_jiandan.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.name_jiandan.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.name_jiandan.api.** {
    <init>(...);
