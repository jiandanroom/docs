...
import com.name_jiandan.api.core.Params
...
private constructor(
     ...
     */
    fun age(): Optional<Long> = body.age()
     ...
     */
    fun _age(): JsonField<Long> = body._age()
    ...
    class Builder internal constructor() {
        ...
        fun age(age: Long) = apply { body.age(age) }

        /**
         * Sets [Builder.age] to an arbitrary JSON value.
         *
         * You should usually call [Builder.age] with a well-typed [Long] value instead. This method
         * is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun age(age: JsonField<Long>) = apply { body.age(age) }
    ...
    private constructor(
        ...
        private val age: JsonField<Long>,
        ...
        private constructor(
            ...
            @JsonProperty("age") @ExcludeMissing age: JsonField<Long> = JsonMissing.of(),
        ) : this(email, name, age, mutableMapOf())
        ...
        /**
         * @throws NameJiandanInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
         */
        fun age(): Optional<Long> = age.getOptional("age")
         ...
         * Unlike [age], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("age") @ExcludeMissing fun _age(): JsonField<Long> = age
        ...
        class Builder internal constructor() {
            ...
            private var age: JsonField<Long> = JsonMissing.of()
            ...
            fun age(age: Long) = age(JsonField.of(age))

            /**
             * Sets [Builder.age] to an arbitrary JSON value.
             *
             * You should usually call [Builder.age] with a well-typed [Long] value instead. This
             * method is primarily for setting the field to an undocumented or not yet supported
             * value.
             */
            fun age(age: JsonField<Long>) = apply { this.age = age }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && email == other.email && name == other.name && age == other.age && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(email, name, age, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{email=$email, name=$name, age=$age, additionalProperties=$additionalProperties}"
    }
