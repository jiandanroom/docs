...
import com.name_jiandan.api.client.NameJiandanClientAsyncImpl
...
class NameJiandanOkHttpClientAsync private constructor() {
    ...
    /** A builder for [NameJiandanOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [NameJiandanClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NameJiandanClientAsync =
            NameJiandanClientAsyncImpl(
                clientOptions
