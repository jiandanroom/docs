...
package com.name_jiandan.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.name_jiandan.api.client.NameJiandanClient
import com.name_jiandan.api.client.NameJiandanClientImpl
...
/**
 * A class that allows building an instance of [NameJiandanClient] with [OkHttpClient] as the
...
class NameJiandanOkHttpClient private constructor() {
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [NameJiandanClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): NameJiandanClient = builder().fromEnv().build()
    }

    /** A builder for [NameJiandanOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [NameJiandanClient].
         *
